        ...
        $(document).ready(function() {
            ...
            tableKegiatan = $('#table-kegiatan').DataTable({
                ...
                columns: [{
                    ...
                    data: "surat_tugas", // Menambahkan kolom surat tugas
                    className: "text-center",
                    orderable: false,
                    searchable: false,
                    render: function(data, type, row) {
                        // Menampilkan tombol download jika ada file surat_tugas
                        if (data) {
                            return '<a href="{{ url('kegiatan_diikuti/export_pdf') }}/' + row.kegiatan_id + '" class="btn btn-primary btn-sm">Download Surat Tugas</a>';
                        } else {
                            return 'Tidak Ada';
                        }
                    }
