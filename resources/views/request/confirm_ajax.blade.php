...
@else
    <form action="{{ url('/request/' . $user->id . '/delete_ajax') }}" method="POST" id="form-delete">
        @csrf
        @method('DELETE')
        <div id="modal-master" class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <table class="table table-sm table-bordered table-striped">
                        ...
                        <tr>
                            ...
                            <td class="col-9">{{ $user->dosen_nip }}</td>
                        </tr>
                        <tr>
                            <th class="text-right col-3">Jabatan :</th>
                            <td class="col-9">{{ $user->jabatan->nama_jabatan }}</td>
                        </tr>
                        <tr>
                            <th class="text-right col-3">Bobot :</th>
                            <td class="col-9">{{ $user->bobot }}</td>
                        </tr>
                        <tr>
