    ...
    <div class="card card-outline card-primary">
        <div class="card-header">
            ...
            <div class="card-tools">
                <button class="btn btn-sm btn-primary" onclick="modalAction('{{ url('/request/create_ajax/' . $kegiatan->kegiatan_id) }}')" >Tambah Anggota</button>
            </div>
        </div>
        <div class="card-body">
            @if (session('success'))
    ...
    <script>
        ...
        $(document).ready(function() {
            var tablePendingApproval = $('#table_pending_approval').DataTable({
                ...
                processing: true,
                ajax: {
                    "url": "{{ url('request/list/'.$kegiatan->kegiatan_id) }}", // Ganti dengan URL endpoint yang sesuai
                    "dataType": "json",
                    "type": "POST",
                    "data": function(d){
